<?php
		...
		*/
		...
		{
			$to = 'shamir@sypherlabs.com,jan.donyada@sypherlabs.com';
			$subject = 'Versafleet Form Submission';
			...
			$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U35989"],ENT_COMPAT,'UTF-8') . '</td></tr>';
			...
			$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message:</b></td><td>' . htmlentities($_REQUEST["custom_U35978"],ENT_COMPAT,'UTF-8') . '</td></tr>';
			$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Cell Phone:</b></td><td>' . htmlentities($_REQUEST["custom_U36014"],ENT_COMPAT,'UTF-8') . '</td></tr>';
			$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Company:</b></td><td>' . htmlentities($_REQUEST["custom_U36078"],ENT_COMPAT,'UTF-8') . '</td></tr>';
