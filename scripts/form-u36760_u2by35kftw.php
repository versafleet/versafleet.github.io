...
if ($_SERVER['REQUEST_METHOD'] == 'POST') 
{
  ...
  $privatekey = "6LeAAvMSAAAAAFmJkb4kQqnhwtX-cUNr8Bdy1JbI";
...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U36777"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message:</b></td><td>' . htmlentities($_REQUEST["custom_U36767"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Cell Phone:</b></td><td>' . htmlentities($_REQUEST["custom_U36785"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Company:</b></td><td>' . htmlentities($_REQUEST["custom_U36761"],ENT_COMPAT,'UTF-8') . '</td></tr>';
